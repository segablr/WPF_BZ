...
namespace WPF_BZ {
    ...
    public partial class DataBaseSQLDataSet : global::System.Data.DataSet {
        ...
        public partial class AutorizationDataTable : global::System.Data.TypedTableBase<AutorizationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AutorizationRow AddAutorizationRow(string Username, string Password, string Access_level) {
        ...
        public partial class AutorizationRow : global::System.Data.DataRow {
            ...
            public string Access_level {
                get {
                    return ((string)(this[this.tableAutorization.Access_levelColumn]));
                }
                set {
                    this[this.tableAutorization.Access_levelColumn] = value;
                }
            }
        }
...
namespace WPF_BZ.DataBaseSQLDataSetTableAdapters {
    ...
    public partial class AutorizationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Autorization] WHERE (([Id] = @Original_Id) AND ([Username] = @" +
                "Original_Username) AND ([Password] = @Original_Password) AND ([Access_level] = @" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Autorization] ([Username], [Password], [Access_level]) VALUES " +
                "(@Username, @Password, @Access_level);\r\nSELECT Id, Username, Password, Access_le" +
                "vel FROM Autorization WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Autorization] SET [Username] = @Username, [Password] = @Password, [Access_level] = @Access_level WHERE (([Id] = @Original_Id) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ([Access_level] = @Original_Access_level));
SELECT Id, Username, Password, Access_level FROM Autorization WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WPF_BZ.Properties.Settings.Default.DataBaseSQLConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Username, Password, Access_level FROM dbo.Autorization";
        ...
        public virtual int Fill(DataBaseSQLDataSet.AutorizationDataTable dataTable) {
        ...
        public virtual DataBaseSQLDataSet.AutorizationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataBaseSQLDataSet.AutorizationDataTable dataTable = new DataBaseSQLDataSet.AutorizationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataBaseSQLDataSet.AutorizationDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Username, string Original_Password, string Original_Access_level) {
        ...
        public virtual int Update(string Username, string Password, string Access_level, int Original_Id, string Original_Username, string Original_Password, string Original_Access_level, int Id) {
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Username, string Password, string Access_level, int Original_Id, string Original_Username, string Original_Password, string Original_Access_level) {
